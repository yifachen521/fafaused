        ...
        <div id="user_content">
            <div class="basic">
               ...
               <div class="changeinfo">
                ...
                <div class="changeinfo">
                    <span>email：</span>
                    <input class="in_info" style="margin-left: 64px" type="email" name="email" value="${cur_user.email}" placeholder="邮箱地址"/>
                </div>
                <hr/>
                <div class="changeinfo">
                    <span>手机号码：</span>
                    <input class="in_info" style="margin-left: 43px" type="text" name="phone" value="${cur_user.phone}" readonly="true"/>
                    <span id="checkphone">已验证</span>
                </div>
                <hr/>
                <div class="changeinfo">
                    <span>QQ：</span>
                    <input class="in_info" style="margin-left: 77px" type="text" name="qq" placeholder="请输入QQ" value="${cur_user.qq}"/>
                </div>
