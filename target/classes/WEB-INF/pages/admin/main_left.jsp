	...
	<div id="sidebar">
		<ul>
			<li class="submenu"><a href="#"><i class="icon icon-group"></i>
					<span>用户管理</span> </a>
				<ul>
					<li><a href="<%=basePath%>admin/searchUser">用户列表</a></li>
					<li><a href="<%=basePath%>admin/userLike">用户分析</a></li>
				</ul>
			</li>
			<li class="submenu"><a href="#"><i class="icon icon-signal"></i>
					<span>商品管理</span> </a>
				<ul>
					<li><a href="<%=basePath%>admin/searchGoods">商品列表</a></li>
				</ul>
			</li>
			<li class="submenu"><a href="#"><i class="icon icon-th"></i>
					<span>订单管理</span> </a>
				<ul>
					<li><a href="<%=basePath%>admin/searchOrders">订单列表</a></li>
			...
			<li class="submenu"><a href="#"><i class="icon icon-fullscreen"></i>
				...
				<ul>
					<li>
					<a href="<%=basePath%>admin/aboutUs">关于我们</a></li>
				</ul>
			</li>
		</ul>
	</div>
